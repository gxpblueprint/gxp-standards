...
sidebar_position: 2
slug: /quality-systems/change-control/sop-change-management
...
```mermaid
flowchart TD
    A[Identify planned change] --> B[Open change record]
    B --> C[Initial GMP impact and classification]
    C --> D[Cross-functional impact assessment]
    D --> E{Approved before implementation?}
    E -- No --> F[Revise, reject, or cancel]
    E -- Yes --> G[Implement approved tasks]
    G --> H[Verify evidence and resolve deviations]
    H --> I{Ready for use?}
    I -- No --> G
